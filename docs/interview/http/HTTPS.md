---
icon: question
description: 前端物语|面试物语-为什么说 HTTPS 比 HTTP 安全? HTTPS 是如何保证安全的？
footer: 为什么说 HTTPS 比 HTTP 安全? HTTPS 是如何保证安全的？
order: 6
star: 6
date: 2023-03-17
author: h7ml
...
tag:
  - interview
  - http
shortTitle: 前端物语|面试物语-为什么说 HTTPS 比 HTTP 安全? HTTPS 是如何保证安全的？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 为什么说 HTTPS 比 HTTP 安全? HTTPS 是如何保证安全的？
---
