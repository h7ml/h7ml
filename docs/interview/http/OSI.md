---
icon: question
description: 前端物语|面试物语-如何理解 OSI 七层模型?
footer: 如何理解 OSI 七层模型?
order: 7
star: 7
date: 2023-03-18
author: h7ml
...
tag:
  - interview
  - http
shortTitle: 前端物语|面试物语-如何理解 OSI 七层模型?
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 如何理解 OSI 七层模型?
---

# 如何理解 OSI 七层模型?

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/e2e1b910-b61e-11eb-ab90-d9ae814b240d.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/eb1b2170-b61e-11eb-ab90-d9ae814b240d.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/f3a89d40-b61e-11eb-85f6-6fac77c0c9b3.png)
