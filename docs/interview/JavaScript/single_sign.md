---
icon: question
description: 前端物语|面试物语-什么是单点登录？如何实现？
footer: 什么是单点登录？如何实现？
order: 32
star: 32
date: 2023-05-24
...
tag:
  - interview
  - JavaScript
shortTitle: 前端物语|面试物语-什么是单点登录？如何实现？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 什么是单点登录？如何实现？
---

# 什么是单点登录？如何实现？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/8a25a760-8c83-11eb-85f6-6fac77c0c9b3.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/2b9b0e70-8c4b-11eb-85f6-6fac77c0c9b3.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/2422bc40-8c84-11eb-ab90-d9ae814b240d.png)
