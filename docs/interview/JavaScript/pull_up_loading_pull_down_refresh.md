---
icon: question
description: 前端物语|面试物语-如何实现上拉加载，下拉刷新？
footer: <a href='https://beian.mit.gov.cn/' target='blank'>浙ICP备2021037683号-2</a>如何实现上拉加载，下拉刷新？
order: 1
star: 1
date: 2023-02-27
author: h7ml
...
tag:
  - interview
  - JavaScript
shortTitle: 前端物语|面试物语-如何实现上拉加载，下拉刷新？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 如何实现上拉加载，下拉刷新？
---

# 如何实现上拉加载，下拉刷新？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/89cd1850-8adc-11eb-ab90-d9ae814b240d.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/df498a00-8ae3-11eb-ab90-d9ae814b240d.png)
