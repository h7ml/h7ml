---
icon: question
description: 前端物语|面试物语-说说你对栈、队列的理解？应用场景？
footer: 说说你对栈、队列的理解？应用场景？
order: 15
star: 15
date: 2023-04-07
author: h7ml
...
tag:
  - interview
  - algorithm
shortTitle: 前端物语|面试物语-说说你对栈、队列的理解？应用场景？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说你对栈、队列的理解？应用场景？
---

# 说说你对栈、队列的理解？应用场景？

![](https://static.h7ml.cn/vitepress/assets/images/interview/bc57f530-1b99-11ec-a752-75723a64e8f5.png)
