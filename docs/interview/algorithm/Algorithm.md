---
icon: question
description: 前端物语|面试物语-说说你对算法的理解？应用场景？
footer: 说说你对算法的理解？应用场景？
order: 17
star: 17
date: 2023-04-14
author: h7ml
...
tag:
  - interview
  - algorithm
shortTitle: 前端物语|面试物语-说说你对算法的理解？应用场景？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说你对算法的理解？应用场景？
---

# 说说你对算法的理解？应用场景？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/eca03690-1620-11ec-8e64-91fdec0f05a1.png)
...
![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/682d16c0-1621-11ec-8e64-91fdec0f05a1.png)

如果我们要实现这个功能， 则可以使用前缀树，如下：

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/55a1ed50-1621-11ec-8e64-91fdec0f05a1.png)
