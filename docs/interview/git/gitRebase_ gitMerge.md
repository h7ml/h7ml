...
![](https://static.h7ml.cn/vitepress/assets/images/interview/77590970-fdd4-11eb-bc6f-3f06e1491664.png)
...
![](https://static.h7ml.cn/vitepress/assets/images/interview/88410a30-fdd4-11eb-991d-334fd31f0201.png)
...
![](https://static.h7ml.cn/vitepress/assets/images/interview/929eb220-fdd4-11eb-991d-334fd31f0201.png)

这时候使用`git merge`的时候，会生成一个新的提交，并且`master`分支的`HEAD`会移动到新的分支上，如下：

![](https://static.h7ml.cn/vitepress/assets/images/interview/9fdfa3e0-fdd4-11eb-991d-334fd31f0201.png)
...
![](https://static.h7ml.cn/vitepress/assets/images/interview/ab2d5120-fdd4-11eb-bc6f-3f06e1491664.png)

通过`git rebase`，会变成如下情况：

![](https://static.h7ml.cn/vitepress/assets/images/interview/b72aed70-fdd4-11eb-991d-334fd31f0201.png)

在移交过程中，如果发生冲突，需要修改各自的冲突，如下：

![](https://static.h7ml.cn/vitepress/assets/images/interview/c9ba0e80-fdd4-11eb-bc6f-3f06e1491664.png)

`rebase`之后，`master`的`HEAD`位置不变。因此，要合并`master`分支和`bugfix`分支

![](https://static.h7ml.cn/vitepress/assets/images/interview/dc660660-fdd4-11eb-991d-334fd31f0201.png)
