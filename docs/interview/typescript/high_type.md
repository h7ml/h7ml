---
icon: question
description: 前端物语|面试物语-说说你对 TypeScript 中高级类型的理解？有哪些？
footer: 说说你对 TypeScript 中高级类型的理解？有哪些？
order: 6
star: 6
date: 2023-03-21
author: h7ml
...
tag:
  - interview
  - typescript
shortTitle: 前端物语|面试物语-说说你对 TypeScript 中高级类型的理解？有哪些？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说你对 TypeScript 中高级类型的理解？有哪些？
---

# 说说你对 TypeScript 中高级类型的理解？有哪些？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/bda521e0-1065-11ec-8e64-91fdec0f05a1.png)
