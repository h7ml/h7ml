---
icon: question
description: 前端物语|面试物语-css 选择器有哪些？优先级？哪些属性可以继承？
footer: <a href='https://beian.mit.gov.cn/' target='blank'>浙ICP备2021037683号-2</a>css 选择器有哪些？优先级？哪些属性可以继承？
order: 1
star: 1
date: 2023-02-24
author: h7ml
...
tag:
  - interview
  - css
shortTitle: 前端物语|面试物语-css 选择器有哪些？优先级？哪些属性可以继承？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: css 选择器有哪些？优先级？哪些属性可以继承？
---

# css 选择器有哪些？优先级？哪些属性可以继承？

![](https://static.h7ml.cn/vitepress/assets/images/interview/f7dcd330-8fe1-11eb-85f6-6fac77c0c9b3.png)
