---
icon: question
description: 前端物语|面试物语-说说 React 中的 setState 执行机制
footer: 说说 React 中的 setState 执行机制
order: 12
star: 12
date: 2023-03-24
author: h7ml
...
tag:
  - interview
  - React
shortTitle: 前端物语|面试物语-说说 React 中的 setState 执行机制
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说 React 中的 setState 执行机制
---

# 说说 React 中的 setState 执行机制

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/3acb8ca0-d825-11eb-85f6-6fac77c0c9b3.png)
