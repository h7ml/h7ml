---
icon: question
description: 前端物语|面试物语-说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？
...
tag:
  - interview
  - React
shortTitle: 前端物语|面试物语-说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？
---

# 说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/5c717010-d373-11eb-85f6-6fac77c0c9b3.png)
