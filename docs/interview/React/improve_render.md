---
icon: question
description: 前端物语|面试物语-说说你是如何提高组件的渲染效率的？在 React 中如何避免不必要的 render？
footer: 说说你是如何提高组件的渲染效率的？在 React 中如何避免不必要的 render？
order: 30
star: 30
date: 2023-04-21
author: h7ml
...
tag:
  - interview
  - React
shortTitle: 前端物语|面试物语-说说你是如何提高组件的渲染效率的？在 React 中如何避免不必要的 render？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说你是如何提高组件的渲染效率的？在 React 中如何避免不必要的 render？
---

# 说说你是如何提高组件的渲染效率的？在 React 中如何避免不必要的 render？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/de2d7e20-ecf8-11eb-85f6-6fac77c0c9b3.png)
