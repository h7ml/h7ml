---
icon: question
description: 前端物语|面试物语-说说 react 中引入 css 的方式有哪几种？区别？
footer: 说说 react 中引入 css 的方式有哪几种？区别？
order: 8
star: 8
date: 2023-03-12
author: h7ml
...
tag:
  - interview
  - React
shortTitle: 前端物语|面试物语-说说 react 中引入 css 的方式有哪几种？区别？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说 react 中引入 css 的方式有哪几种？区别？
---

# 说说 react 中引入 css 的方式有哪几种？区别？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/7d825230-e217-11eb-ab90-d9ae814b240d.png)
