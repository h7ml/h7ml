---
icon: question
description: 前端物语|面试物语-你是怎么理解 ES6 中 Generator 的？使用场景？
footer: <a href='https://beian.mit.gov.cn/' target='blank'>浙ICP备2021037683号-2</a>你是怎么理解 ES6 中 Generator 的？使用场景？
order: 1
star: 1
date: 2023-03-01
author: h7ml
...
tag:
  - interview
  - es6
shortTitle: 前端物语|面试物语-你是怎么理解 ES6 中 Generator 的？使用场景？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 你是怎么理解 ES6 中 Generator 的？使用场景？
---

# 你是怎么理解 ES6 中 Generator 的？使用场景？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/7db499b0-5947-11eb-ab90-d9ae814b240d.png)
