---
icon: question
description: 前端物语|面试物语-v-show 和 v-if 有什么区别？使用场景分别是什么？
footer: <a href='https://beian.mit.gov.cn/' target='blank'>浙ICP备2021037683号-2</a>v-show 和 v-if 有什么区别？使用场景分别是什么？
order: 7
star: 7
date: 2023-03-06
author: h7ml
...
tag:
  - interview
  - vue
shortTitle: 前端物语|面试物语-v-show 和 v-if 有什么区别？使用场景分别是什么？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: v-show 和 v-if 有什么区别？使用场景分别是什么？
---

# v-show 和 v-if 有什么区别？使用场景分别是什么？

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/d21c3c50-3acb-11eb-85f6-6fac77c0c9b3.png)
