---
icon: question
description: 前端物语|面试物语-Vue 常用的修饰符有哪些有什么应用场景
footer: <a href='https://beian.mit.gov.cn/' target='blank'>浙ICP备2021037683号-2</a>Vue 常用的修饰符有哪些有什么应用场景
order: 5
star: 5
date: 2023-03-04
author: h7ml
...
tag:
  - interview
  - vue
shortTitle: 前端物语|面试物语-Vue 常用的修饰符有哪些有什么应用场景
isOriginal: false
head:
  - - meta
    - name: keywords
      content: Vue 常用的修饰符有哪些有什么应用场景
---

# Vue 常用的修饰符有哪些有什么应用场景

![](https://static.h7ml.cn/vitepress/assets/images/interview/8f718e30-42c0-11eb-ab90-d9ae814b240d.png)
