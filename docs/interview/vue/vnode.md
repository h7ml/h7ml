---
icon: question
description: 前端物语|面试物语-什么是虚拟 DOM？如何实现一个虚拟 DOM？说说你的思路
footer: 什么是虚拟 DOM？如何实现一个虚拟 DOM？说说你的思路
order: 21
star: 21
date: 2023-04-09
author: h7ml
...
tag:
  - interview
  - vue
shortTitle: 前端物语|面试物语-什么是虚拟 DOM？如何实现一个虚拟 DOM？说说你的思路
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 什么是虚拟 DOM？如何实现一个虚拟 DOM？说说你的思路
---

# 什么是虚拟 DOM？如何实现一个虚拟 DOM？说说你的思路

![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/770b9670-442c-11eb-85f6-6fac77c0c9b3.png)
...
真实的`DOM`节点，哪怕一个最简单的`div`也包含着很多属性，可以打印出来直观感受一下： ![](https://nakoruru.h7ml.cn/httpproxy/static.5ibug.net/vitepress/assets/images/interview/cc95c7f0-442c-11eb-ab90-d9ae814b240d.png)
