---
icon: question
description: 前端物语|面试物语-说说你对输入输出重定向和管道的理解？应用场景？
footer: 说说你对输入输出重定向和管道的理解？应用场景？
order: 6
star: 6
date: 2023-04-01
author: h7ml
...
tag:
  - interview
  - linux
shortTitle: 前端物语|面试物语-说说你对输入输出重定向和管道的理解？应用场景？
isOriginal: false
head:
  - - meta
    - name: keywords
      content: 说说你对输入输出重定向和管道的理解？应用场景？
---

# 说说你对输入输出重定向和管道的理解？应用场景？

![](https://static.h7ml.cn/vitepress/assets/images/interview/1036dde0-0634-11ec-a752-75723a64e8f5.png)
...
![](https://static.h7ml.cn/vitepress/assets/images/interview/1a57caf0-0634-11ec-8e64-91fdec0f05a1.png)
