...
::: tip 温馨提示阅读[《你不知道的 JavaScript（中卷）》](https://www.ituring.com.cn/book/1563)和各个大佬的文章所归纳的总结，**如有异议按你的理解为主** :::
...
String(obj2); // toString             => 'h7ml'

/** 隐式类型转换 */
1 + obj1; // valueOf              => 2022
1 + obj2; // valueOf   toString   => '1h7ml'

'str: ' + obj1; // valueOf              => 'str: 2021'
'str: ' + obj2; // valueOf   toString   => 'str: h7ml'
```
...
::: tip 在**逻辑操作符**与**条件判断语句**中都是做 `ToBoolean` 处理 :::
